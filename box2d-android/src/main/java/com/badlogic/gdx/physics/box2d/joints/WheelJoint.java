...
public class WheelJoint extends Joint implements fr.byob.game.box2d.dynamics.joints.WheelJoint {
	// @off
	/*JNI
#include <Box2D/Box2D.h>
	 */

	public WheelJoint (final World world, final long addr) {
		super(world, addr);
	}
	...
	public float getMotorTorque (final float invDt) {
