 ...
 * @author mzechner */
public class ContactImpulse extends fr.byob.game.box2d.callbacks.ContactImpulse {
	// @off
	/*JNI
#include <Box2D/Box2D.h>
	...
	final World world;
	long addr;
	float[] tmp = new float[Settings.maxManifoldPoints];

	protected ContactImpulse (final World world, final long addr) {
		this.world = world;
		this.addr = addr;
	}
