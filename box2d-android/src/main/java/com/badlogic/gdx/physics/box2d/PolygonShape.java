...
public class PolygonShape extends Shape implements fr.byob.game.box2d.collision.shapes.PolygonShape, BoxShape {
	// @off
	/*JNI
	 ...
	 * edge. */
	public void set (final Vector[] vertices) {
	...
	public void set (final float[] vertices) {
	...
	public void set (final float[] vertices, final int offset, final int len) {
	...
	public void setAsBox (final float hx, final float hy, final Vector center, final float angle) {
