...
JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_physics_box2d_Body_jniGetContactList(JNIEnv* env, jobject object, jlong addr) {

		b2Body* body = (b2Body*)addr;
		return (jlong)body->GetContactList();
